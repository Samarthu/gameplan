...
const STATUS_ORDER = ['In Progress', 'Reopen', 'Ready for Testing', 'Hold', 'QA Accepted', 'Live', 'Under Testing', 'Under Code Review', 'Ready to Merge', 'Todo', 'Backlog', 'Done', 'Cancelled', 'Not a Bug']
const STATUS_META = {
  ...
  'Under Code Review': { dotClass: 'bg-cyan-500', barClass: 'bg-cyan-500' },
...
const STATUS_GROUPS = [
  ...
  { label: 'Active', statuses: ['In Progress', 'Reopen', 'Ready for Testing', 'Hold', 'QA Accepted', 'Live', 'Under Testing', 'Under Code Review', 'Ready to Merge'] },
